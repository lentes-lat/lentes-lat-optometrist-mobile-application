      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'pagos') : PagosWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => AppointmentDetailsProfileWidget(
            currentOrderDetails:
                params.getParam('currentOrderDetails', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'OrderAcceptance',
          path: '/orderAcceptance',
          builder: (context, params) => OrderAcceptanceWidget(),
        ),
        FFRoute(
          name: 'prescriptionform',
          path: '/prescriptionform',
          builder: (context, params) => PrescriptionformWidget(
            orderInfo: params.getParam('orderInfo', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'orderDetails',
        ...
        FFRoute(
          name: 'OfflinePage',
          path: '/offlinePage',
          builder: (context, params) => OfflinePageWidget(),
        ),
        FFRoute(
          name: 'orderDetailsHistory',
          path: '/orderDetailsHistory',
          builder: (context, params) => OrderDetailsHistoryWidget(
            orderDetailHistory:
                params.getParam('orderDetailHistory', ParamType.JSON),
          ),
        )
